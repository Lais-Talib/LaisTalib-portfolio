...
const Projects = () => {
  const projects = [
    {
      title: 'CloudSaaS Analytics',
      desc: 'A comprehensive analytics dashboard for SaaS companies with real-time data visualization.',
      image: '/p1.png',
    ...
    },
    {
      ...
      desc: 'Secure and sleek cryptocurrency wallet with multi-chain support and instant swaps.',
      image: '/p2.png',
    ...
    {
      title: 'NeoTask Manager',
      desc: 'Collaborative task management tool with AI-driven prioritization and team insights.',
